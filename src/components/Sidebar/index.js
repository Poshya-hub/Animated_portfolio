import "./index.scss";
import log from "./logo1-removebg-preview.png";
    ...
    <>
      <div className="nav-bar">
        ...
        <ul>
          <li>
            <a
              href="https://www.linkedin.com/in/talasu-poshya/"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li>
            <a
              href="https://github.com/Poshya-hub"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li>
            <a
              href="https://www.codechef.com/users/talasuposhya20"
              target="_blank"
              rel="noreferrer"
            >
